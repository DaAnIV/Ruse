...
pub struct SeqTripleIterator<I>
where
...
pub fn seq_triple_iterator<I>(children_iterator: I) -> SeqTripleIterator<I>
where
    I: ProgramChildrenIterator,
{
    SeqTripleIterator {
...
where
    I: ProgramChildrenIterator,
{
    pub async fn next(&mut self) -> Option<SeqTriple> {
